    ...
    >
      ...
      >
        ...
        >
          <div>
            <span>
              {" "}
              <img
                src={require("../../../Assets/signs/location-dark.svg").default}
                alt=""
              />{" "}
              {location}
            </span>
            <span>
              {" "}
              <img src={require("../../../Assets/signs/web.png")} alt="" />{" "}
              {theme}
            </span>
            <span>
              {" "}
        ...
        <div className={`${viewData === "list" && "footer-list"}`}>
          ...
          <div
            className={`${
              viewData === "grid" ? "listing-footer" : "listing-footer-list"
            }`}
          >
            <NormalButton name={btnName} isArrow={true} className="apply-btn" />
          </div>
        </div>
      </div>
    </div>
